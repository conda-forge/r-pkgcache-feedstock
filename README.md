...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-pkgcache-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6899&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-pkgcache-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-pkgcache` can be installed with:

```
conda install r-pkgcache
```

It is possible to list all of the versions of `r-pkgcache` available on your platform with:
